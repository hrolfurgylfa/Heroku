...
def Verkefni_6():
    ...
    for notandi in oll_password:
        if notandi[0] == username:
            notandi_til = True
            if notandi[2] == "1":
                return template("Verkefni_6/admin.tpl", u = str(username), o = oll_password)
            else:
                return template("Verkefni_6/error.tpl", t = "Þessi notandi er ekki með næg réttindi", u = username)
