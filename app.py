...
skraarnafn = "static/Verkefni_6/password.txt"
...
def Verkefni_6():
    ...
    for notandi in oll_password:
        if notandi[0] == username:
            if notandi[2] == "1": return template("Verkefni_6/admin.tpl", u = str(username), o = oll_password)
            else: return template("Verkefni_6/error.tpl", t = "Þessi notandi er ekki með næg réttindi")
        else: return template("Verkefni_6/index.tpl")
...
def Verkefni_6_innskraning():
    ...
    if notandi_rett_adgangsord is True and user_rettir is 1:
...
@route("/Verkefni_6/utskra")
def Verkefni_6_utskra():
...
@route("/Verkefni_6/eyda_notenda")
def Verkefni_6_eyda_notenda():
...
@route("/Verkefni_6/breyta_notendanafni")
def Verkefni_6_breyta_notendanafni():
    breyta_user = request.query.u
    current_user = request.get_cookie("innskraning_hrolfurgylfa_heroku_verkefni6", secret='')
    allir_notendur = saekjaNotendur()
